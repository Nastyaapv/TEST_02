...
class Test405:
    ...
    @allure.testcase("https://tr.instream.ru:7443/testrail/index.php?/cases/view/54674")
    def test_c54674_main(self, profile_api, cn, dbCursor):
        logging.info("Тест начат. Ссылка на ТК: https://tr.instream.ru:7443/testrail/index.php?/cases/view/54674")
        logging.info("Удалить базовый атрибут. Не указывать id")
